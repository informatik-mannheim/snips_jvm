...
You need a Java Runtime Environment for Java 8 or higher. Download the jar `file snips-core-0.8.x-jar-with-dependencies.jar` and save it where ever you want.
...
`java -cp snips-core-0.8.x.jar net.gumbix.codesnippet.SnippetFileCollector src snippets srcPublic .java "//" False`
...
`java -cp snips-core-0.8.x.jar net.gumbix.codesnippet.SnippetFileCollector src snippets_solution srcSolution .java "//" True`
